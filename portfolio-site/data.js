  ...
  projects: [
    {
      ...
      badge: 'FIELD SYSTEM', status: '검증 완료 · 자동 보정 연동 진행 중', statusType: 'progress',
      featured: true,
      image: './assets/tactile-gui.png', imageAlt: '촉각센서 실시간 측정 GUI',
      ...
      stack: ['Fairino FR5','Python','PyQt5','I2C','DI','PGC-140'], evidence: 'https://github.com/ptk3917/robotics-portfolio/blob/main/docs/2026-08-operator-station.ko.md'
    },
    {
      title: '자연어 비전 픽킹',
      badge: 'ROBOT VISION', status: '실기 검증 완료', statusType: 'complete', image: './assets/vlm-picking.png', imageAlt: '자연어 비전 픽킹 파이프라인',
      ...
      stack: ['Qwen2.5-VL','RealSense','FR5','Python'], evidence: 'https://github.com/ptk3917/robotics-portfolio#1-자연어-비전-픽킹'
    },
    {
      title: 'YOLO11 OBB 방향 정렬',
      badge: 'VISION', status: '실기 검증 완료', statusType: 'complete', image: './assets/obb-sorting.png', imageAlt: 'YOLO11 OBB 검출 기반 제품 방향 정렬',
      ...
      stack: ['YOLO11 OBB','PyTorch','FR5'], evidence: 'https://github.com/ptk3917/robotics-portfolio#2-방향-감지-및-정렬-yolo11-obb'
    },
    {
      title: 'ROS2 식판 검증·보정 시스템',
      badge: 'ROS2',
      status: '판단 로직 검증 완료', statusType: 'complete',
      ...
      stack: ['ROS2 Humble','YOLO','JSON/YAML','FR5'], evidence: 'https://github.com/ptk3917/robotics-portfolio#5-ros2-식판-검증-시스템'
    },
    {
      title: 'Unity 디지털 트윈 / ServoJ 실기 검증',
      badge: 'SIM2REAL', status: 'Phase 0 실기 검증 완료', statusType: 'complete',
      ...
      stack: ['Unity','UDP','ServoJ','URDF'], evidence: 'https://github.com/ptk3917/robotics-portfolio#6-sim2real-디지털-트윈-unity'
    },
    {
      title: '3D 스캔 · RGB-D 외관검사',
      badge: 'INSPECTION', status: '프로토타입 완료 · 기술 한계 확인', statusType: 'limited', image: './assets/scan-gui.png', imageAlt: 'RGB-D 스캔 포인트 운영 GUI',
      ...
      stack: ['RealSense','OpenCV','PyQt5','Point Cloud'], evidence: 'https://github.com/ptk3917/robotics-portfolio#4-3d-스캔--외관검사'
    },
    {
      title: '벽 장착 FR5 충돌 오탐 진단',
      badge: 'DIAGNOSTICS', status: '원인 분리 · 수정 후 완주 검증', statusType: 'complete', image: './assets/fr5-zangle-diagnosis.png', imageAlt: 'FR5 설치각과 잔여토크 진단 결과',
      ...
      stack: ['FR5 SDK','Torque Analysis','Python'], evidence: 'https://github.com/ptk3917/robotics-portfolio/blob/main/docs/2026-08-diagnostics.ko.md'
    },
    {
      title: 'Industrial IoT / Smart Factory Data Pipeline',
      badge: 'IIOT', status: '현장 구축 경험', statusType: 'complete',
